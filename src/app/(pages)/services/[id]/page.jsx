                    ...
                    <div className="row justify-content-between">
                        <div className="col-xl-8">
                            ...
                            <div className="row mil-mb-60-adapt">
                                ...
                                {(pageData?.features || [])
                                    .filter((item) => item?.room_features_id) // убираем null связи
                                    .map((item, key) => (
                                        <div className="col-xl-4" key={`page-features-item-${key}`}>
                                            <div className="mil-iconbox mil-iconbox-sm mil-mb-40-adapt mil-fade-up">
                                                ...
                                                {item?.room_features_id?.icon && (
                                                    <div className="mil-icon mil-icon-fix">
                                                        <img
                                                            src={getDirectusImageURL(item.room_features_id.icon)}
                                                            alt={item?.room_features_id?.name || ""}
                                                        />
                                                    </div>
                                                )}

                                                {/* название показываем даже без иконки */}
                            ...
                            {block_faq && <FaqSection {...block_faq} />}
                        </div>
