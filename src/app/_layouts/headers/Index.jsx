...
const HeaderModule = ({ data }) => {
  ...
  return (
    <>
      {data && (
        <header className={`mil-top-panel ${toggle ? "mil-menu-opened" : ""}`}>
          <div className="container">
            <div className="mil-top-panel-content">
              ...
              <a href="tel:+79787668130" className="mil-mobile-phone">
                ...
                >
                  <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6A19.79 19.79 0 0 1 2.12 4.18 2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.12.9.33 1.78.63 2.62a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.46-1.2a2 2 0 0 1 2.11-.45c.84.3 1.72.51 2.62.63A2 2 0 0 1 22 16.92z" />
                </svg>
                    ...
                    {data.main_menu.items.map((item, index) => (
                      ...
                      >
                        <Link
                          ...
                          onClick={
                            toggle && item.submenu && item.submenu.length > 0
      ...
      <div className={`mil-book-popup-frame ${toggleBooking ? "mil-active" : ""}`}>
        <div className="mil-book-popup">
          <div className="mil-popup-head mil-mb-40">
            <h3 className="mil-h3-lg">Бронирование</h3>

            <button
              type="button"
              className="mil-close-button"
              onClick={(e) => bookingOpen(e)}
              aria-label="Закрыть"
            >
              <svg
