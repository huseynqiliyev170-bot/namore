        ...
        <>
            ...
            <div className="mil-banner">
                ...
                <div className="container">
                    <div className={`mil-banner-img-${imgLayout} w-screen w-screen`}>
                        {image &&
                        <Image src={getDirectusImageURL(image)} alt={image.title} fill sizes="100vw"   className="object-cover" priority />
                        }
                        ...
                        <div className="col-xl-10">
                            ...
                            <div className="mil-banner-content-frame">
                                <div className="mil-banner-content">
                                    ...
                                    {info_text &&
                                    <p><span className="mil-accent-2">*</span>{info_text}</p>
                                    }
                                </div>
                            </div>
